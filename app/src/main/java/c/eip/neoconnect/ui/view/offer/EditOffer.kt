...
class EditOffer : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.getOneOffer(token!!, offerId).observe(viewLifecycleOwner, Observer {
            it?.let { resource ->
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.editOfferButton).setOnClickListener {
            ...
            viewModel.editOffer(token!!, offerId, offreModel).observe(viewLifecycleOwner, Observer {
                it?.let { resource ->
                    when (resource.status) {
                        Status.SUCCESS -> {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (data != null) {
            ...
            Glide.with(requireContext()).load(selectedImage).diskCacheStrategy(DiskCacheStrategy.RESOURCE)
